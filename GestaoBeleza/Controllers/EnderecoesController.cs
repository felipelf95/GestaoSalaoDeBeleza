...
namespace GestaoBeleza.Controllers
{
    public class EnderecoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EnderecoId,Cep,Logradouro,Bairro,Cidade,Estado,NumeroCasa,Complemento")] Endereco endereco)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EnderecoId,Cep,Logradouro,Bairro,Cidade,Estado,NumeroCasa,Complemento")] Endereco endereco)
        {
